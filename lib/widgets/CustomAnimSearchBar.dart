...
class CustomAnimSearchBar extends StatefulWidget {
  ...
  const CustomAnimSearchBar({
    ...
    this.inputFormatters, this.onTaped,required this.height, this.onSearchTaped,
  }) : super(key: key);
          ...
          children: [
            Padding(
              ...
              child: AnimatedContainer(
                duration: Duration(milliseconds: widget.animationDurationInMilli),
                height: (toggle == 0) ? 45.0 : widget.height,
                width: (toggle == 0) ? 45.0 : widget.width,
                    ...
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            widget.onTaped();
                            widget.onSearchTaped(widget.textController.value.toString());
                            setState(
                                  () {
...
// CustomAnimSearchBar(
//   prefixIcon: Image.asset("assets/booking_search.png"),
//   suffixIcon: SizedBox(
//         width: 25,
//         height: 25,
//         child: Image.asset("assets/booking_search.png",color: Constants.secondColor,)
//     ),
//
//   height: 45,
